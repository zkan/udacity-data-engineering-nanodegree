...
if __name__ == "__main__":
    ...
    parser.add_argument("--input", type=str, help="HDFS input", default="/global_temperature_data")
    parser.add_argument("--output", type=str, help="HDFS output", default="/global_temperature_output")
    args = parser.parse_args()

    spark = SparkSession \
        .builder \
        .appName("Global Temperature Data Processor") \
        .getOrCreate()
